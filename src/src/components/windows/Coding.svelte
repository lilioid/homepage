...
<template>
	<div>
		...
		<div class="project">
			...
			<p>
				During the <i>EU vs Virus</i> Hackathon some friends and I programmed an application for viewing online
				Lectures together. Hence we called it Lecture2Gether.
			</p>
			<p>
